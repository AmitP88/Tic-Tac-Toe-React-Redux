import { PLAYER_CHOOSES_CELL_1, PLAYER_CHOOSES_CELL_2, PLAYER_CHOOSES_CELL_3, PLAYER_CHOOSES_CELL_4, PLAYER_CHOOSES_CELL_5, PLAYER_CHOOSES_CELL_6, PLAYER_CHOOSES_CELL_7, PLAYER_CHOOSES_CELL_8, PLAYER_CHOOSES_CELL_9 } from '../actions/playerActions';
// import initialState from '../store/store';

const playersMoveReducer = (state = null, action) => {
    switch(action.type) {
